              ...
              return (
                ...
                >
                  <CardContent className="p-5 space-y-3">
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400">{c.city ?? ''}{c.city ? ', ' : ''}{c.country} · {c.companySize ?? '—'} employees</p>
                    {c.contactName && (
                      <p className="text-xs text-slate-600 dark:text-slate-300">{c.contactName} · {c.contactRole}</p>
                    )}
                    <div className="flex gap-4 text-xs text-slate-600 dark:text-slate-300 pt-1 border-t border-slate-100 dark:border-slate-700">
