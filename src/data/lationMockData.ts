...
export const mockTalents: Talent[] = [
  {
    ...
    specialization: 'Frontend', employment_type: 'full_time', status: 'active',
  ...
  },
  {
    ...
    specialization: 'Backend', employment_type: 'full_time', status: 'active',
  ...
  },
  {
    ...
    specialization: 'Backend', employment_type: 'contract', status: 'active',
  ...
  },
  {
    ...
    specialization: 'Frontend', employment_type: 'full_time', status: 'placed',
  ...
  },
  {
    ...
    specialization: 'Full Stack', employment_type: 'freelance', status: 'active',
  ...
  },
  {
    ...
    specialization: 'Full Stack', employment_type: 'full_time', status: 'reviewing',
  ...
  },
  {
    ...
    specialization: 'Mobile', employment_type: 'contract', status: 'active',
...
export const mockEmployers: Employer[] = [
  {
    ...
    contact_phone: '+1 312 693 0162', status: 'active',
  ...
  },
  {
    ...
    contact_name: 'Jorge Mendez', contact_email: 'j.mendez@softtk.com', status: 'active',
  ...
  },
  {
    ...
    contact_phone: '+34 91 123 4567', status: 'active',
    created_at: '2026-01-10T10:00:00Z', updated_at: '2026-01-10T10:00:00Z',
  },
  {
    id: 'e4', company_name: 'TechMilenio', industry: 'IT Services', country: 'Mexico',
    email: 'rh@techmilenio.mx', phone: '+52 81 9876 5432',
    contact_name: 'Claudia Vega', contact_email: 'c.vega@techmilenio.mx', status: 'prospect',
